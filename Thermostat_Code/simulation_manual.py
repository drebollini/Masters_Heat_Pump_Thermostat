...
plt.title("Manual Thermostat Simulation")
...
hspace=0.2,
wspace=0.2)
plt.savefig("Manual_Thermostat_Simulation.pdf")
plt.show()
...
plt.title("Manual Thermostat Simulation - Heat Pump Power")
plt.figure(1).set_figwidth(15)
plt.subplots_adjust(top=0.88,
bottom=0.3,
left=0.055,
...
hspace=0.2,
wspace=0.2)
plt.savefig("Manual_Thermostat_Simulation_Power.pdf")
plt.show()
